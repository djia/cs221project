%Load the data
addpath(genpath('/home/kannu/Desktop/Stanford_AI/work/project/shared/cs221project'))
...
%		examplesTest = out_of_sample(examplesTest, mapping);
	    ...
	    % SVM classifier
                 model = svmtrain(labelsTraining, examplesTraining, '-c 0.1 -t 2');
                 [predictions, accuracy_array, dec_values] = svmpredict(labelsTest, examplesTest, model);     %test it
		 accuracy_per_sub(i) = .01*accuracy_array(1);
